...
export default function StrokeArticlePage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const encodedTitle = encodeURIComponent('Kako prepoznati simptome moždanog udara');
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden mb-12 shadow-2xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            Brzo prepoznavanje simptoma moždanog udara može spasiti život. Naučite kako prepoznati rane znakove i kada potražiti hitnu medicinsku pomoć.
          </p>
        </div>
      </div>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-2">FAST metoda za prepoznavanje moždanog udara</h2>
                  <p className="text-muted-foreground">
                    Brza akcija može značiti razliku između života i smrti. Naučite kako prepoznati znakove moždanog udara.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">F (Face/Lice)</h3>
                  <p className="text-muted-foreground">Je li jedna strana lica opuštena? Može li osoba nasmiješiti se?</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">A (Arms/Ruke)</h3>
                  <p className="text-muted-foreground">Može li osoba podići obje ruke? Je li jedna ruka slabija?</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">S (Speech/Govor)</h3>
                  <p className="text-muted-foreground">Je li govor nerazumljiv ili otežan? Može li osoba ponoviti jednostavnu rečenicu?</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">T (Time/Vrijeme)</h3>
                  <p className="text-muted-foreground">Ako primijetite bilo koji od ovih simptoma, odmah nazovite hitnu pomoć!</p>
                </div>
              </div>

              <div className="space-y-6">
                <h3 className="text-2xl font-bold">Dodatni simptomi</h3>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>Iznenadna utrnulost ili slabost u nozi</li>
                  <li>Zbunjenost ili poteškoće s razumijevanjem</li>
                  <li>Poteškoće s vidom u jednom ili oba oka</li>
                  <li>Vrtoglavica ili gubitak ravnoteže</li>
                  <li>Jaka glavobolja bez poznatog uzroka</li>
                </ul>

                <h3 className="text-2xl font-bold">Što učiniti ako primijetite simptome?</h3>
                <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                  <li>Odmah nazovite hitnu pomoć (124)</li>
                  <li>Zabilježite vrijeme kada su simptomi počeli</li>
                  <li>Ne dajte osobi ništa jesti ili piti</li>
                  <li>Održavajte osobu u udobnom položaju</li>
                  <li>Budite uz osobu dok ne stigne hitna pomoć</li>
                </ol>
              </div>
            </div>
          </div>
      ...
      <div className="mt-16 bg-primary/10 rounded-xl p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">Hitna medicinska pomoć</h2>
        <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
          Ako primijetite bilo koji od simptoma moždanog udara, odmah nazovite hitnu pomoć (124). 
