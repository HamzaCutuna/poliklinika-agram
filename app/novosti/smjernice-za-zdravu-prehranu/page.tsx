...
export default function HealthyDietArticlePage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const encodedTitle = encodeURIComponent('Smjernice za zdravu prehranu');
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden mb-12 shadow-2xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
          ...
          <p className="text-lg text-white/90 max-w-2xl">
            Zdrava prehrana je temelj dobrog zdravlja. Otkrijte kako možete poboljšati svoje prehrambene navike i živjeti zdraviji život.
          </p>
        </div>
      </div>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-2">Osnove zdrave prehrane</h2>
                  <p className="text-muted-foreground">
                    Uravnotežena prehrana je ključna za održavanje dobrog zdravlja i prevenciju bolesti.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Makronutrijenti</h3>
                  <p className="text-muted-foreground">Ugljikohidrati, proteini i zdrave masti su temeljni elementi zdrave prehrane.</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Mikronutrijenti</h3>
                  <p className="text-muted-foreground">Vitamini i minerali su neophodni za pravilno funkcioniranje organizma.</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Vlakna</h3>
                  <p className="text-muted-foreground">Dovoljan unos vlakana pomaže u održavanju zdrave probave.</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Antioksidansi</h3>
                  <p className="text-muted-foreground">Zaštitni elementi koji pomažu u borbi protiv slobodnih radikala.</p>
                </div>
              </div>

              <div className="space-y-6">
                <h3 className="text-2xl font-bold">Prehrambene smjernice</h3>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>Jestite raznovrsnu hranu</li>
                  <li>Uključite dosta voća i povrća</li>
                  <li>Odaberite cjelovite žitarice</li>
                  <li>Ograničite unos šećera i soli</li>
                  <li>Pijte dovoljno vode</li>
                  <li>Pratite redovite obroke</li>
                  <li>Kontrolirajte veličinu porcija</li>
                  <li>Ograničite prerađenu hranu</li>
                </ul>

                <h3 className="text-2xl font-bold">Savjeti za implementaciju</h3>
                <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                  <li>Planirajte obroke unaprijed</li>
                  <li>Pripremajte hranu kod kuće</li>
                  <li>Čitajte etikete na proizvodima</li>
                  <li>Kupujte sezonsko voće i povrće</li>
                  <li>Uključite zdrave masti</li>
                  <li>Ograničite alkoholne piće</li>
                </ol>
              </div>
            </div>
          </div>
      ...
      <div className="mt-16 bg-primary/10 rounded-xl p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">Zatražite savjet o prehrani</h2>
        <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
          Naši stručnjaci za prehranu mogu vam pomoći razviti personalizirani prehrambeni plan koji odgovara vašim potrebama i ciljevima.
        </p>
        <Link href="/kontakt">
