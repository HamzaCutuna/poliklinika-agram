...
export default function StressManagementArticlePage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const encodedTitle = encodeURIComponent('Zdravi načini za upravljanje stresom');
  ...
  return (
    <div className="container mx-auto px-4 py-12">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm text-white/90">
              {formatDate('2024-04-18')}
            </span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white leading-tight">
            Zdravi načini za upravljanje stresom
          </h1>
          <p className="text-lg text-white/90 max-w-2xl">
            Kronični stres može negativno utjecati na fizičko i mentalno zdravlje. Otkrijte učinkovite strategije za smanjenje stresa i poboljšanje dobrobiti.
          </p>
        </div>
      </div>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-2">Utjecaj stresa na zdravlje</h2>
                  <p className="text-muted-foreground">
                    Kronični stres može dovesti do ozbiljnih zdravstvenih problema. Saznajte kako ga prepoznati i upravljati njime.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Fizički simptomi</h3>
                  <p className="text-muted-foreground">Glavobolja, napetost u mišićima, umor, poremećaji spavanja i probavni problemi.</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Emocionalni simptomi</h3>
                  <p className="text-muted-foreground">Anksioznost, depresija, razdražljivost i poteškoće s koncentracijom.</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Ponašajni simptomi</h3>
                  <p className="text-muted-foreground">Prekomjerno jedenje ili gubitak apetita, izbjegavanje obaveza, povećana konzumacija alkohola.</p>
                </div>
                <div className="bg-primary/5 rounded-xl p-6">
                  <h3 className="text-xl font-semibold mb-3">Kognitivni simptomi</h3>
                  <p className="text-muted-foreground">Zabrinutost, brzopletost, poteškoće s pamćenjem i konstantno razmišljanje o problemima.</p>
                </div>
              </div>

              <div className="space-y-6">
                <h3 className="text-2xl font-bold">Strategije za upravljanje stresom</h3>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>Redovita tjelesna aktivnost i vježbe</li>
                  <li>Tehnike opuštanja i meditacija</li>
                  <li>Zdrava prehrana i dovoljno sna</li>
                  <li>Postavljanje granica i prioriteta</li>
                  <li>Traženje podrške od obitelji i prijatelja</li>
                  <li>Praktične tehnike upravljanja vremenom</li>
                  <li>Hobiji i aktivnosti za opuštanje</li>
                  <li>Profesionalna pomoć kada je potrebna</li>
                </ul>

                <h3 className="text-2xl font-bold">Preventivne mjere</h3>
                <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                  <li>Identificirajte izvore stresa</li>
                  <li>Razvijte rutinu za opuštanje</li>
                  <li>Održavajte zdrav životni stil</li>
                  <li>Praktičirajte mindfulness</li>
                  <li>Učite govoriti "ne"</li>
                  <li>Održavajte ravnotežu između posla i privatnog života</li>
                </ol>
              </div>
            </div>
          </div>
      ...
      <div className="mt-16 bg-primary/10 rounded-xl p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">Brinite o svom mentalnom zdravlju</h2>
        <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
          Ako imate poteškoća s upravljanjem stresom, nemojte se ustručavati potražiti stručnu pomoć. 
          Naši liječnici su tu da vam pomognu.
        </p>
        <Link href="/kontakt">
